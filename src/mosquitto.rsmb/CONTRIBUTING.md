Contributing to Mosquitto RSMB
==============================
...
This is the RSMB component of the Mosquitto project, which provides MQTT-SN
support as well as MQTT support.
...
- http://github.com/eclipse/mosquitto.rsmb
...
1. [Fork the repository on GitHub](https://github.com/eclipse/mosquitto.rsmb/fork)
2. Clone the forked repository onto your computer: ``` git clone
   https://github.com/<your username>/mosquitto.rsmb.git ```
...
10. Finally, go to
	[https://github.com/eclipse/mosquitto.rsmb](https://github.com/eclipse/mosquitto.rsmb)
...
This project uses [Github](https://github.com/eclipse/mosquitto.rsmb/issues)
...
- [Create new Mosquitto bug](https://github.com/eclipse/mosquitto.rsmb/issues)
